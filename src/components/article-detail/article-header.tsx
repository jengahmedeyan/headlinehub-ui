...
export function ArticleHeader() {
  ...
  // add share original link using handleNativeShare
  const handleShareOriginal = () => {
    if (navigator.share) {
      navigator.share({
        title: article.title,
        text: `Check out this article from ${article.source}`,
        url: article.link,
      });
    } else {
          ...
          <div className="flex flex-row gap-3">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuItem onClick={handleShareOriginal}>
                  <ExternalLink className="h-4 w-4 mr-2" />
                  Share Original Link
                </DropdownMenuItem>
